Pod::Spec.new do |s|
  s.name             = "LMSQLite.swift"
  s.version          = "1.15.3"
  s.summary          = "A type-safe, Swift-language layer over SQLite3."

  s.description      = <<-DESC
    LMSQLite.swift provides compile-time confidence in SQL statement syntax and
    intent.
                       DESC
  ...
  s.source           = { :git => "https://github.com/R1Daneel/SQLite.swift.git", :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/stephencelis'

  s.module_name      = 'LMSQLite'
  ...
  s.subspec 'standard' do |ss|
    ss.source_files = 'Sources/LMSQLite/**/*.{c,h,m,swift}'
    ss.exclude_files = 'Sources/**/Cipher.swift'
    ss.library = 'sqlite3'
    ss.resource_bundle = { 'LMSQLite.swift' => 'Sources/LMSQLite/PrivacyInfo.xcprivacy' }
